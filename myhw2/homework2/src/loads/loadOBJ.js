					...
					object.traverse(function (child) {
						if (child.isMesh) {
							...
							switch (objMaterial) {
								...
								case 'PRTMaterial':
									//precomputeLT自动传递
									//把precomputeL从9×RGB转换成3×9
									let PrecomputeLRGB = getMat3ValueFromRGB(precomputeL[guiParams.envmapId])
									// test();
									// material = buildPRTMaterial("./src/shaders/PRTShader/RPTVertex.glsl", "./src/shaders/PRTShader/PRTFragment.glsl");
									material = buildPRTMaterial(PrecomputeLRGB,"./src/shaders/prtShader/PRTVertex.glsl", "./src/shaders/prtShader/PRTFragment.glsl");
